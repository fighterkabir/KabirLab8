...
self.addEventListener('fetch', function (event) {
  ...
  //            network response.
    ...
    // ** CITATION NOTE **:
    /*
        This code was taken from the article referenced above: 
        https://developer.chrome.com/docs/workbox/caching-strategies-overview/.

        It can be found under the "Cache first, falling back to network" header.
        It was slightly modified, but most of it is direct from the function written.
        The comments are also straight from the function.
    */
